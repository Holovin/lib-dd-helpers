...
class Logger extends singleton_1.Singleton {
    constructor() {
        ...
        logAllFilename = logAllFilename !== null && logAllFilename !== void 0 ? logAllFilename : this.config.get('dd:log:all');
        logBaseLevel = logBaseLevel !== null && logBaseLevel !== void 0 ? logBaseLevel : this.config.get('dd:log:base');
        logConsoleLevel = logConsoleLevel !== null && logConsoleLevel !== void 0 ? logConsoleLevel : this.config.get('dd:log:console');
        logErrorFilename = logErrorFilename !== null && logErrorFilename !== void 0 ? logErrorFilename : this.config.get('dd:log:error');
        logInfoFilename = logInfoFilename !== null && logInfoFilename !== void 0 ? logInfoFilename : this.config.get('dd:log:info');

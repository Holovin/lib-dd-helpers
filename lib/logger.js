...
class Logger extends singleton_1.Singleton {
    constructor() {
        ...
        const loggerFormatter = winston_1.format.printf(info => { var _a; return `[${info.timestamp}] (${(_a = info.service.padEnd(15, ' ')) !== null && _a !== void 0 ? _a : '?'}) ${info.level.toUpperCase()}: ${info.message}`; });
        ...
        if (this.config.get('dd:log:default')) {
            logAllFilename = logAllFilename !== null && logAllFilename !== void 0 ? logAllFilename : 'log_all.log';
            logBaseLevel = logBaseLevel !== null && logBaseLevel !== void 0 ? logBaseLevel : 'silly';
            logConsoleLevel = logConsoleLevel !== null && logConsoleLevel !== void 0 ? logConsoleLevel : 'verbose';
            logErrorFilename = logErrorFilename !== null && logErrorFilename !== void 0 ? logErrorFilename : 'log_error.log';
            logInfoFilename = logInfoFilename !== null && logInfoFilename !== void 0 ? logInfoFilename : 'log_info.log';
        }
        if (logDirectory) {
